...
var myPets: pet[] = [
    ...
    var comparadorAge = function (a:pet , b: pet) {
        if (a.age > b.age) { return -1; }
        if (a.age < b.age) {return 1; }
        return 0;
    }
    
    console.log(myPets.sort(comparadorAge));

    var comparadorWeight = function (a:pet , b: pet) {
        if (a.weight > b.weight) { return -1; }
        if (a.weight < b.weight) {return 1; }
        return 0;
    }
    
    console.log(myPets.sort(comparadorWeight));